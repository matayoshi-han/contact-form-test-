...
<div class="confirm__content">
    ...
    <form class="form" action="/contacts" method="post">
            ...
            <table class="confirm-table__inner">
                <tr class="confirm-table__row">
                    ...
                    <td class="confirm-table__text">
                        <input type="text" name="name" value="{{ $contact['first-name'],$contact['last-name'] }}" readonly />
                    </td>
                </tr>
                <tr class="confirm-table__row">
        ...
        <div class="form__button">
            <button class="form__button-submit_send" type="submit">送信</button>
            <button class="form__button-submit_correction" type="submit">修正</button>
        </div>
    </form>
    @endsection